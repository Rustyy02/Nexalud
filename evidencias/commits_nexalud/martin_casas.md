...
* **13 de Octubre:** Creación de la primera versión del frontend para Boxes.
* **15 de Octubre:** Actualización y mejoras en el componente `Home.jsx`.
* **23 de Octubre:** Actualización del modelo de Pacientes en la base de datos.
* **23 de Octubre:** Finalización del frontend para el listado de pacientes.
...
* **6 de Noviembre:** Implementación del cálculo de tiempos de duración por etapas.
* **8 de Noviembre:** Finalización del cronómetro para el control de tiempo en consultas.
* **8 de Noviembre:** Implementación de la lógica para marcar faltas por retraso o no presentación.
* **9 de Noviembre:** Funcionalidad para pausar y cancelar rutas (finalizada).
* **10 de Noviembre:** Finalización de la funcionalidad de consulta de retrasos.
* **13 de Noviembre:** Finalización del Dashboard y del módulo de insight "Nexathink".