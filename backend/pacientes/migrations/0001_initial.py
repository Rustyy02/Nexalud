    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut', models.CharField(default='', help_text='RUT en formato chileno XX.XXX.XXX-X', max_length=12, unique=True, validators=[django.core.validators.RegexValidator(message='El RUT debe estar en formato chileno: XX.XXX.XXX-X (ejemplo: 12.345.678-9)', regex='^\\d{1,2}\\.\\d{3}\\.\\d{3}-[0-9kK]$')])),
                ...
                ('nombre', models.CharField(help_text='Nombre(s) del paciente', max_length=100, null=True)),
                ('apellido_paterno', models.CharField(help_text='Apellido paterno del paciente', max_length=100, null=True)),
                ('apellido_materno', models.CharField(blank=True, help_text='Apellido materno del paciente (opcional)', max_length=100, null=True)),
                ('fecha_nacimiento', models.DateField(help_text='Fecha de nacimiento del paciente', null=True)),
                ...
                ('correo', models.EmailField(blank=True, help_text='Correo electrónico del paciente', max_length=254, null=True, validators=[django.core.validators.EmailValidator()])),
                ('telefono', models.CharField(help_text='Teléfono celular en formato +56912345678', max_length=13, null=True, validators=[django.core.validators.RegexValidator(message='El teléfono debe estar en formato chileno: +56912345678', regex='^\\+56\\d{9}$')])),
                ...
                ('direccion_calle', models.CharField(help_text='Calle y número', max_length=255, null=True)),
                ('direccion_comuna', models.CharField(help_text='Comuna', max_length=100, null=True)),
                ('direccion_ciudad', models.CharField(help_text='Ciudad', max_length=100, null=True)),
                ('direccion_region', models.CharField(choices=[('XV', 'Región de Arica y Parinacota'), ('I', 'Región de Tarapacá'), ('II', 'Región de Antofagasta'), ('III', 'Región de Atacama'), ('IV', 'Región de Coquimbo'), ('V', 'Región de Valparaíso'), ('RM', 'Región Metropolitana de Santiago'), ('VI', "Región del Libertador General Bernardo O'Higgins"), ('VII', 'Región del Maule'), ('XVI', 'Región de Ñuble'), ('VIII', 'Región del Biobío'), ('IX', 'Región de La Araucanía'), ('XIV', 'Región de Los Ríos'), ('X', 'Región de Los Lagos'), ('XI', 'Región Aysén del General Carlos Ibáñez del Campo'), ('XII', 'Región de Magallanes y de la Antártica Chilena')], help_text='Región de Chile', max_length=5, null=True)),
                ('direccion_codigo_postal', models.CharField(blank=True, default='Sin proporcionar', help_text='Código postal (opcional)', max_length=10)),
                ...
                ('peso', models.DecimalField(blank=True, decimal_places=2, default='DESCONOCIDO', help_text='Peso en kilogramos', max_digits=5, null=True)),
